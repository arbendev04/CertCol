...
export function Benefits() {
  return (
    <section id="beneficios" className="py-24 bg-surface-container">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {benefits.map(({ icon: Icon, title, description }) => (
            <div
              key={title}
              className="bg-surface-bright rounded-2xl p-8 group hover:ambient-shadow transition-all duration-300"
            >
              <div className="w-10 h-10 rounded-lg bg-[#0A4D8C]/8 flex items-center justify-center mb-5">
                <Icon size={20} className="text-[#0A4D8C]" />
              </div>
